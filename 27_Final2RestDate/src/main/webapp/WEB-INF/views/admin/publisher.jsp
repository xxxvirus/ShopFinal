...
<div class="container-fluid text-left" ng-app="app"	ng-controller="mainCtrl">
	...
	<div class="row" ng-show="currentView == 'form'">
		<form name='frm' class="form-horizontal" novalidate>
			<div class="form-group">
				<label for="" class="control-label col-md-2">Publisher</label>
				<div class="col-md-6">
					<input name="name" ng-model="currentItem.name" class="form-control" ng-required='true' type="text">
				</div>
			</div>
			<div class="form-group">
